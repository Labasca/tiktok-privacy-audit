📦
93641 /automation/phone/undim.js
58638 /automation/phone/undim.js.map
✄
...
// automation/phone/undim.js
rpc.exports = {
  undim: function() {
    const out = { tried: [] };
    const done = { v: true };
    const UA = frida_objc_bridge_default.classes.SBUserAgent;
    const BL = frida_objc_bridge_default.classes.SBBacklightController;
    const LM = frida_objc_bridge_default.classes.SBLockScreenManager;
    function note(k, v) {
      out.tried.push(k + "=" + v);
    }
    frida_objc_bridge_default.schedule(frida_objc_bridge_default.mainQueue, function() {
      try {
        if (UA) {
          UA.sharedUserAgent().undimScreen();
          note("undim", "ok");
        }
      } catch (e) {
        note("undim", String(e));
      ...
      try {
        if (BL) {
          BL.sharedInstance()["turnOnScreenFullyWithBacklightSource:"](0);
          note("bl", "ok");
        }
      } catch (e) {
        note("bl", String(e));
      ...
      if (LM) {
        ...
        try {
          ...
          try {
            inst["attemptUnlockWithPasscode:"]("");
            note("passEmpty2", "ok");
          } catch (e2) {
            note("passEmpty", String(e2));
          }
        }
        try {
          note("locked1", String(inst.isUILocked()));
        } catch (e) {
        }
      }
      done.v = true;
