📦
93359 /automation/phone/share_tiktok.js
58288 /automation/phone/share_tiktok.js.map
✄
...
// automation/phone/share_tiktok.js
function nsstr(s) {
  return frida_objc_bridge_default.classes.NSString.stringWithString_(s);
}
rpc.exports = {
  openInTikTok: function(path) {
    const out = { path, tried: [] };
    const url = frida_objc_bridge_default.classes.NSURL.fileURLWithPath_(nsstr(path));
    out.url = url.absoluteString().toString();
    const LS = frida_objc_bridge_default.classes.LSApplicationWorkspace;
    ...
    if (WS) {
      tryCall("openSensitiveURL", function() {
        const opts = frida_objc_bridge_default.classes.NSMutableDictionary.dictionary();
